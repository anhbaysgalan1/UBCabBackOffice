//
// //
// // // Back Office const variables
// //
//
var BASE_URL = 'https://hjfm8bz1wf.execute-api.eu-central-1.amazonaws.com/inhouse'
...
var selectOptionsCountry = [
  { value: '10', label: 'Монгол' },
  { value: '20', label: 'English' },
  { value: '30', label: 'Русский' }
]

var selectOptionsCity = [
  { value: '101', label: 'Улаанбаатар' },
  { value: '102', label: 'Эрдэнэт' },
  { value: '103', label: 'Дархан' }
]
...
module.exports = {
  ...
  selectOptionsCity, // For selets in ExtendedForms view
